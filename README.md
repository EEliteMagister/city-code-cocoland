...
Le fichier zip-code-cocoland.json à été généré avec l'outil *coco zip code tool* créé spécialement pour récuperer la base de données depuis coco.gg, exemple: [http://coco.gg/codep/75.js](https://coco.gg/codep/75.js)
